...
const LandingPage = () => {
  const phrases = ["አግሮLink", "የገበሬው ምርጥ አጋር"];
  ...
  const features = [
    {
      ...
      description:
        "Direct marketplace eliminating middlemen. Farmers get fair prices, buyers get fresh produce straight from source.",
      image: farmer,
    ...
    },
    {
      ...
      description:
        "Instant diagnosis from plant photos. Get treatment plans to save your crops before damage spreads.",
      image: detection,
    ...
    },
    {
      ...
      description:
        "Virtual agronomist in your pocket. Get personalized advice on soil health, pest control, and crop cycles in Amharic or Oromiffa.",
      image: advisorBot,
    ...
    },
    {
      ...
      description:
        "Precision forecasts and future predictions for your exact location. We also offer soil moisture analysis",
      image: weather,
  ...
  Services
        ...
        <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
          ...
          <div className="relative z-20 px-4 w-full">
            <h1
              className={`text-5xl md:text-7xl font-bold mb-6 transition-opacity duration-1000 ${
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-10 font-light">
              <span>Farmer’s Best Partner </span>
            </p>
        ...
        <section id="services" className="py-24 px-4 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.bgColor} backdrop-blur-md border border-gray-700/30 rounded-3xl`}
                ></div>
                    ...
                    >
                      ...
                      <div
                        className={`absolute inset-0 bg-gradient-to-t ${
                          feature.bgColor.split(" ")[0]
                        }/80 via-transparent to-transparent`}
                      ></div>
                    </div>
                  </div>
                ) : (
