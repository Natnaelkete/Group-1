...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="sticky top-0 z-[100] backdrop-blur-lg bg-white/90 border-b border-gray-200 shadow-sm">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-40 z-[200]">
                {Object.entries(flags).map(([lng, flagUrl]) => (
                  ...
                  >
                    <img src={flagUrl} alt={`${lng} flag`} className="w-5 h-3 rounded-sm" />
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-green-800">User</span>
